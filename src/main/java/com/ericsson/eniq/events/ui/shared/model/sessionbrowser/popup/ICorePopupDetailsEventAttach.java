...
/**
 * Attach Event popup details for the WCDMA Core network events,
 * @author edarbla
 * @since 06 2012
 */
@ResultSetMappingInfo(fieldMappings = {
        ...
        @FieldMappingInfo(fieldName = "Attach Type", columnName = "ATTACH_TYPE_DESC", groupId = "Event Details"),
...
public interface ICorePopupDetailsEventAttach {
    /**
