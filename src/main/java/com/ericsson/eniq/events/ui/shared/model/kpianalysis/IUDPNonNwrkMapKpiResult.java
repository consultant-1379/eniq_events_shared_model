...
@ResultSetMappingInfo(fieldMappings = {
        @FieldMappingInfo(fieldName = "cellId", columnName = "CID"),
        ...
        @FieldMappingInfo(fieldName = "cellName", columnName = "CELL_NAME"),
...
public interface IUDPNonNwrkMapKpiResult extends IEventData {
