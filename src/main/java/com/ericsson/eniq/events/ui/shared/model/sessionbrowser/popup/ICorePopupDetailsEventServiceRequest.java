...
@ResultSetMappingInfo(fieldMappings = {
        ...
        @FieldMappingInfo(fieldName = "Service Type", columnName = "SERVICE_TYPE", groupId = "Event Details"),
        @FieldMappingInfo(fieldName = "Service Request Trigger", columnName = "SERVICE_TRIGGER", groupId = "Event Details"),
        @FieldMappingInfo(fieldName = "Paging Attempts", columnName = "PAGING_ATTEMPTS", groupId = "Event Details"),
...
public interface ICorePopupDetailsEventServiceRequest {
    /**
