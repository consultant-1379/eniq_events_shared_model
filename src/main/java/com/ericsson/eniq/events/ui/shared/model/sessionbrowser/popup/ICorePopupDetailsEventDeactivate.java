...
@ResultSetMappingInfo(fieldMappings = {
        ...
        @FieldMappingInfo(fieldName = "Deactivation Trigger", columnName = "DEACTIVATION_TRIGGER", groupId = "Event Details"),
...
public interface ICorePopupDetailsEventDeactivate {
    /**
