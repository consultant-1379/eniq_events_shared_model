...
@ResultSetMappingInfo(fieldMappings = {
        ...
        @FieldMappingInfo(fieldName = "Detach Type", columnName = "DETACH_TYPE", groupId = "Event Details"),
        @FieldMappingInfo(fieldName = "Detach Trigger", columnName = "DETACH_TRIGGER", groupId = "Event Details"),
...
public interface ICorePopupDetailsEventDetach {
    /**
