...
/**
 * Popup details for the WCDMA Handover Failure Analysis, HSDSCH fail event.
 *
 * @author eeidpar
 * @since 06 2012
 */
@ResultSetMappingInfo(fieldMappings = {
        ...
        @FieldMappingInfo(fieldName = "Source Sec. Serving HSDSCH Cell CID", columnName = "SOURCE_SEC_SERV_HSDSCH_CID", groupId = "Handover Details"),
        ...
        @FieldMappingInfo(fieldName = "Target Sec. Serving HSDSCH Cell CID", columnName = "TARGET_SEC_SERV_HSDSCH_CID", groupId = "Handover Details"),
...
public interface IHfaHSDSCHPopupDetails {
    /**
